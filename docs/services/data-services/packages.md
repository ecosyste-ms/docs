...
* Access package information from thousands of sources in a standard format
* See how well used a package is, by other packages (transient dependencies) and repositories (direct dependencies)
